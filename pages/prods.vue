    ...
    <div class="mx-auto px-4 my-4 lg:max-w-7xl lg:px-8">
      <div class="grid grid-cols-1 md:flex items-center justify-between">
        ...
        <div class="flex items-center gap-0.5 justify-center md:justify-end my-4">
          ...
          <nuxt-link :to="{ name: 'prods', query: { page: 1, ...route.query, by: 'LowPrice' } }" class="px-4 h-8 text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Дешевле</nuxt-link>
          <nuxt-link :to="{ name: 'prods', query: { page: 1, ...route.query, by: 'HighPrice' } }" class="px-4 h-8 text-sm flex items-center justify-center text-gray-500 bg-white rounded-r-sm border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Дороже</nuxt-link>
        </div>
