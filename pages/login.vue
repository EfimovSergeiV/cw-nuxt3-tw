...
<template>
  <div class="mx-auto max-w-7xl px-4 lg:max-w-7xl lg:px-8 py-8">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="bg-white border-gray-200 border dark:border-gray-700 dark:bg-gray-800 py-12 px-8 rounded-sm">
        ...
        <div class="">
          ...
          <div class="py-2">
            <!-- <div class="">
              <label for="message" class="block mt-2 mb-1 text-xs font-medium text-gray-900 dark:text-gray-400">Логин</label>
              <div class="relative">
            ...
            <!-- <div class="">
              <label for="message" class="block mt-2 mb-1 text-xs font-medium text-gray-900 dark:text-gray-400">Пароль</label>
              <div class="relative">
                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
