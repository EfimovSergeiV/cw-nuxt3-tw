<script setup>
  ...
  // const changeCitySelected = (city) => {
  //   console.log('changeCitySelected', city)
  //   selectCity = city
  ...
  <div class="mx-auto px-4 lg:max-w-7xl lg:px-8 py-2">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-6 gap-4 text-center">
      ...
      <div class="mt-2 bg-white rounded-sm border dark:border-gray-700 dark:bg-gray-800 shadow-md">
        <div class="relative">
          <iframe :src="mapURLs[shopStore.city]" width="100%" height="350" frameborder="0" loading="lazy" class="rounded-sm"></iframe>
