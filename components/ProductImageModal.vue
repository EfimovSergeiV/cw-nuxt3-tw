          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="">
              ...
              <div class="flex justify-between items-start px-4 py-2 rounded-t border-b dark:border-gray-600">
                ...
                <button @click="productsStore.clearProductImages" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
