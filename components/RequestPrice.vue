          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="">
              ...
              <div class="">
                ...
                <div class="p-6 space-y-6 h-[24rem] xl:h-[30rem] overflow-y-auto">
              ...
              <div class="grid grid-cols-1 gap-4 items-end justify-between p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="">
                    ...
                    <input v-model="clientStore.client.city" type="text" id="contacts" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-50 dark:border-gray-600 placeholder-gray-600 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ваш номер телефона или email">
                  </div>
                  <div class="">
